      ...
      <Container className="rm-container">
        <Row>
          <Col className="privacy">
            ...
            <p>
              If you are creating a poll on Kukkee or voting on a poll, or just
            ...
            <p>
              <ul>
                ...
                <li>
                  If you provide us with personal availability information about
                  other people, or if others give us your personal availability
                  information, we will only use that information for the
                  specific reason for which it was provided to us. By submitting
            ...
            <p>
              <ul>
                <li>
                  ...
                  continue browse this website's pages, but you won't be able to
                  create polls or vote on polls.
                </li>
                <li>
                  ...
                  delete cookies through your browser settings. If you turn off
                  cookies, you can continue to use the website and browse its
                  pages, but Kukkee's user experience would deteriorate.
                </li>
              </ul>
            </p>
            <h2>Your rights</h2>
            <p>
              ...
              <ul>
                <li>
                  ...
                  will provide you with the information within one month of your
                  request, unless doing so would adversely affect the rights and
                  freedoms of other (e.g. another person's personal or event
                  details). We'll tell you if we can't meet your request for
                  that reason.
                </li>
                <li>
                ...
                <li>
                  ...
                  deleting the polls you created.
                </li>
                <li>
            ...
            <p>
              ...
              interact with Kukkee. These are 'persistent' cookies which do not
              delete themselves and help us recognise you when you return so we
              can provide a tailored service.
            </p>
            ...
            <p>
              ...
              <a href="https://stefaniapassera.com/">Stefania Passera</a> - get
              your own{" "}
